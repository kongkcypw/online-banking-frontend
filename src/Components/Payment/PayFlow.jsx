...
const PayFlow = ({ srcInfo, destType, destInfo, payDestID, payRequireInfo, payRequireInput, payAmount, payDescription }) => {
            ...
            {(destType === "topup" || destType === "bill")
                ? <div className='text-left grid grid-cols-4 pt-8'>
                    ...
                    <div className='col-span-3'>
                        <p>{destInfo.Name}</p>
                        <p>{destInfo.Type}</p>
                        {payRequireInfo && payRequireInfo.map((require, index) => (
                ...
                destType === "transfer"
                    ? <div className='text-left grid grid-cols-4 pt-8'>
                        ...
                        <div className='col-span-3'>
                            <p>{destInfo.FirstName} {destInfo.LastName}</p>
                            <p>ธ.{destInfo.BankName}</p>
                            <p>{payDestID}</p>
                        </div>
                    </div>
                    : <div></div>}
