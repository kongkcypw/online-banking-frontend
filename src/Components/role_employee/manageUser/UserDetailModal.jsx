    ...
    return (
        <div>
            <div className='fixed flex start-0 top-0 justify-center z-20 bg-black bg-opacity-30 h-screen w-full '>
                <div className='relative bg-white rounded-lg max-w-4xl min-h-[60vh] w-full my-auto'>
                    ...
                    <p className='text-red-600 ms-24 -mt-6'>คำเตือน: กรุณาตรวจสอบให้เเน่ใจว่าไม่มีเงินอยู่ในบัญชีเเล้วเมื่อต้องการที่จะลบบัญชี</p>
                    <div className='flex justify-center w-auto mt-4'>
                        <div className='flex items-center text-white font-medium rounded-md px-5 py-2 bg-red-500'>
                            <MdDeleteOutline />
                            <p>ลบบัญชี</p>
                        </div>
                    </div>
