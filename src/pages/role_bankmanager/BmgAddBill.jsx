            ...
            <div className='flex'>
                ...
                <div className='ml-8 w-full'>
                    <div className='text-left p-12'>
                        <p className='text-3xl font-semibold'>เพิ่มบริการจ่ายบิล</p>
                        <p className='pt-2 text-lg'>เพิ่มช่องทางการจ่ายบิลให้กับลูกค้า</p>

                        <div className='bg-white text-center text-xl max-w-6xl p-8 mt-8'>
                            <div className='grid grid-cols-10 gap-12'>
                                <div className='col-span-5 flex gap-4'>
                                    <span className='min-w-fit'>ชื่อบริการจ่ายบิล</span>
                                    <input
                                        type='text'
                            ...
                            {requireArray.map((data, index) => (
                                <div key={index} className='py-4'>
                                    ...
                                    <div className='grid grid-cols-12 pt-2'>
                                        ...
                                        <div className='col-span-6 flex gap-[16px]'>
                                            <p className='min-w-fit'>จำนวนเงินขั้นต่ำในการจ่ายบิล</p>
                                            <input
                                                type='text'
                                                className='border-2 px-2'
                                                placeholder='100, 200'
